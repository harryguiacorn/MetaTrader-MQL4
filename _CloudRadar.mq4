...
string _arrayCurrencyGroup1[] = {"EURUSD", "GBPUSD", "AUDUSD", "NZDUSD", "USDJPY", "USDCAD"};
string _arrayCurrencyGroup2[] = {"EURJPY", "EURCAD", "EURAUD", "EURNZD", "EURGBP"};
string _arrayCurrencyGroup3[] = {"GBPJPY", "GBPCAD", "GBPAUD", "GBPNZD"};
string _arrayCurrencyGroup4[] = {"AUDJPY", "AUDCAD", "AUDNZD", "NZDJPY", "NZDCAD", "CADJPY"};
string _arrayCurrencyGroup5[] = {"USB30YUSD", "USB10YUSD", "WTICOUSD", "DE10YBEUR", "XAUUSD", "XAGUSD"};
string _arrayCurrencyGroup6[] = {"SPX500USD", "US30USD", "NAS100USD", "US2000USD", "UK100GBP"};
string _arrayCurrencyGroup7[] = {"CORNUSD", "WHEATUSD", "SUGARUSD", "SOYBNUSD", "NATGASUSD", "XCUUSD"};

string _arrayTimeFrameText[] = {"W1", "D1", "H4", "H1", "M30", "M15", "M5"};                           
int _arrayTimeFrameEnum[] = {PERIOD_W1, PERIOD_D1, PERIOD_H4, PERIOD_H1, PERIOD_M30, PERIOD_M15, PERIOD_M5}; 
...
int _drawGroup()
{
   ...
   { 
      hasRunOnce = true;
      int __groupWidth = 360, __groupHeight = 150; // 275, 150;
      _createGroup(_arrayCurrencyGroup1,offsetX,                     offsetY,"Group1");
      _createGroup(_arrayCurrencyGroup2,offsetX + __groupWidth,      offsetY,"Group2");
      _createGroup(_arrayCurrencyGroup3,offsetX + __groupWidth * 2,  offsetY,"Group3");
...
void _createHeader(string& __arrayCurrencyGroup[], int __groupX, int __groupY, string __groupName, int __offsetX = 65)
{
   ...
   ObjectSetText(__objectNameADX,"ADX", font_size, _font, colourFont);
